...
import com.johnnyconsole.android.ims.databinding.ActivityAddUserBinding
...
class AddUserActivity : AppCompatActivity() {
    ...
    private inner class AddUserTask: AsyncTask<String, Unit, String>() {
        ...
        override fun doInBackground(vararg params: String): String {
            val conn = (URL("https://wildfly.johnnyconsole.com:8443/ims-restful/api/user/add").openConnection()) as HttpsURLConnection
